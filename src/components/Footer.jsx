            ...
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                <div className="justify-between sm:flex">
                    ...
                    <p className="font-bold italic text-2xl text-white">Arqum Ahmad</p>
                        ...
                        A Frontend React Developer skilled in creating dynamic and responsive web applications and Application Development.
                        </p>
                    ...
                    <div className="mt-6">
                        ...
                        <a href="mailto:arqumahmad019@gmail.com" class="font-bold italic text-xl text-white">Gmail: Arqum Ahmad</a> <br/>
                        <a href='https://www.linkedin.com/in/arqum-ahmad-bb5851248/' className="font-bold italic text-xl text-white">LinkdIn: Arqum Ahmad</a> <br/>
